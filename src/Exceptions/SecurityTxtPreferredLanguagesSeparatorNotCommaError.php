...
class SecurityTxtPreferredLanguagesSeparatorNotCommaError extends SecurityTxtError
{
	 ...
	 */
	public function __construct(array $wrongSeparators, array $languages, ?Throwable $previous = null)
	{
